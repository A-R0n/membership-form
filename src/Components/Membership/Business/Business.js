	...
	render() {
		return (
			<form className="Business">
				<svg className="BusinessTitleField" height={70}>
					<text x='40' y='50' className="BusinessTitle">Business Information</text>
				</svg>
				<fieldset>
					<p>Occupation:</p>
					<select className="form-control dropdown" id="occupation" name="occupation">
